...
const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/wardrobe-questionnaires", label: "Wardrobe Questionnaires", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 7l2 2 4-4" },
    ],
  },
  {
    title: "Content",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/image-review", label: "Image Review", icon: "M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z M15 12a3 3 0 11-6 0 3 3 0 016 0z" },
